                    ...
                    ->schema([
                        ...
                        Select::make('source_type')
                            ...
                            ->afterStateUpdated(function (Set $set, ?string $state): void {
                                if ($state === CookieScriptSourceType::External->value) {
                                    $set('code', null);
                        ...
                        TextInput::make('src')
                            ...
                            ->required(fn (Get $get): bool => $get('source_type') === CookieScriptSourceType::External->value)
                            ->visible(fn (Get $get): bool => $get('source_type') === CookieScriptSourceType::External->value)
                            ->maxLength(2048)
                            ->columnSpan(1),
                        Textarea::make('code')
                            ->label('Código inline')
                            ...
                            ->rows(10)
                            ->required(fn (Get $get): bool => $get('source_type') === CookieScriptSourceType::Inline->value)
                            ->visible(fn (Get $get): bool => $get('source_type') === CookieScriptSourceType::Inline->value)
                            ->columnSpanFull(),
